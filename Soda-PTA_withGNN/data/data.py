...
def control(params, pta_option, logger, is_gnn, exepath='wspice1.exe', netlist='data\\benchmark\\ab_ac.sp'):
    """
    ...
    # 
    if is_gnn == 0:
        netlist = 'data/benchmark/' + os.path.basename(netlist)
    else:
        netlist = 'data/other/' + os.path.basename(netlist)
